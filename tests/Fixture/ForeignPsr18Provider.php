...
/**
 * Another package's provider, binding the shared PSR-18 key the way every one of these wrappers
 * used to - `singleton(ClientInterface::class, ...)`.
 *
 * Any request that reaches this client is a request this package sent through someone else's
 * transport, with someone else's timeouts. It records the URI and answers with a body no
