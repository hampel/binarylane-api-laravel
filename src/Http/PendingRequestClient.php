 ...
 *
 * This is the whole reason the package exists. hampel/binarylane-api holds a PSR-18 client of
 ...
 *
 *     Http::fake(['api.binarylane.com.au/*' => Http::response(['servers' => [...]])]);
 *
 *     $servers = BinaryLane::servers()->list();     // the package's real code path
 *
 ...
 * fresh TLS handshake, and BinaryLane pages at 20 unless asked otherwise - and AwaitAction
 * polls one action repeatedly, which is the same cost paid on a timer.
 *
 ...
 * package and has to reach BinaryLane byte for byte - has to supply them itself.
 *
